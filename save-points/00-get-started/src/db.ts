...
export const pizzas = Array<PizzaSpecial>(
  new PizzaSpecial(
    ...
    9.99,
    "./images/pizzas/cheese.jpg",
  ),
  new PizzaSpecial(
    2,
    "The Baconatorizor",
    "It has EVERY kind of bacon",
    11.99,
    "./images/pizzas/bacon.jpg",
  ),
  new PizzaSpecial(
    3,
    "Classic pepperoni",
  ...
  new PizzaSpecial(
    ...
    "When in London...",
    10.25,
    "./images/pizzas/brit.jpg",
  ),
  new PizzaSpecial(
    7,
    "Veggie Delight",
    "It's like salad, but on a pizza",
    11.5,
    "./images/pizzas/salad.jpg",
  ),
  new PizzaSpecial(
    8,
    "Margherita",
